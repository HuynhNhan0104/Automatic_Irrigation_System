...
const char *MQTT_TAG = "MQTT_Handler";

esp_mqtt_client_handle_t client;

void (*on_connect)() = NULL;
void (*on_disconnect)(void*) = NULL;

void (*on_subscribe)(void*) = NULL;
void (*on_unsubscribe)(void*) = NULL;

void (*on_publish)(void*) = NULL;
void (*on_message)(char*, char* ) = NULL;
...
void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        if(on_message != NULL) {
            (*on_message)(event->topic, event->data);
        }
...
int publishMessage(char* message){
    return esp_mqtt_client_publish(client,"v1/devices/me/telemetry",message,0,1,0);
}
